...
const SETTINGS = {
  ...
  description:
    ...
    "Після запису поверніться сюди за посиланням із сайту — нагадаємо про візит за добу й за годину.\n\n" +
  ...
  publicCommands: [
    { command: "start", description: "Про бота й як записатися" },
    { command: "lang", description: "Мова / Language" },
  ],
